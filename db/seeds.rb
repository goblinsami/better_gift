...
Product.create!(name: "Tirador de cerveza portátil", price: 100, age: 50)
Product.create!(name: "Kit de pulseras Topolino", price: 30, age: 10)
Product.create!(name: "Esposas de peluche", price: 25, age: 50)
